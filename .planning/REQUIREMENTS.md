...
- [ ] **PKG-01**: npm package installs skills into ~/.claude/commands/gsd-ml/
- [ ] **PKG-02**: npm package installs workflows, references, templates into ~/.claude/gsd-ml/
- [ ] **PKG-03**: Python package (gsd_ml) installable via pip/uv with ML utilities
- [ ] **PKG-04**: Installer validates Python package works after install
